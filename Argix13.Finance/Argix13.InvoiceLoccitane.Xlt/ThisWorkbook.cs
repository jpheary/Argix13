...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
        //Members
        private const string USP_DETAIL = "uspInvTsortClientInvoiceByReleaseDateWithInfoFromFirstTLGetLoccitane",TBL_DETAIL = "ClientInvoiceTable";
        ...
        private void ThisWorkbook_Startup(object sender,System.EventArgs e) {
            ...
            try {
                ...
                string clid = "",invoice = "";
#if DEBUG
                clid = "012"; invoice = "333989700";    //Loccitane: 012, 333989700
#endif
                if (cmd != null) {
