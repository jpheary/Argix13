...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
        //Members 
        private const string USP_DETAIL = "uspInvTsortReturnInvoiceGet",TBL_DETAIL = "ClientInvoiceTable";
        ...
        private void ThisWorkbook_Startup(object sender,System.EventArgs e) {
            ...
            try {
                ...
                string clid = "",invoice = "";
#if DEBUG
                clid = "120"; invoice = "802176400";    //120-Camper   802176400
#endif
                if (cmd != null) {
        ...
        private void createDetailBody(InvoiceDataset.ClientInvoiceTableDataTable invoiceTable) {
            ...
            for (int i = 0;i < rowCount;i++) {
                values[i,0] = !invoiceTable[i].IsPRONumberNull() ? "'" + invoiceTable[i].PRONumber.Trim() : "";
                values[i,1] = "'" + invoiceTable[i].LocationCode.ToString();
