<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LOccitaneDelivery.aspx.cs" Inherits="_LOccitaneDelivery" %>
...
<div style="margin:20px 0px 0px 83px">
    ...
    <asp:DropDownList ID="cboFilter" runat="server" Width="192px">
        ...
        <asp:ListItem Value="1" Text="OS&amp;D Only" />
    </asp:DropDownList>
</div>
</asp:Content>
