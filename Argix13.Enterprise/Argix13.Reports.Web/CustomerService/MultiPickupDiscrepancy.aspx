<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MultiPickupDiscrepancy.aspx.cs" Inherits="MultiPickupDiscrepancy" %>
...
<div style="margin:0% 2% 0% 0%; text-align:right">
    <asp:CheckBox ID="chkAllVendors" runat="server" Text="Pickups for all vendors" TextAlign="Left" Checked="true" OnCheckedChanged="OnAllVendorsChecked" AutoPostBack="True" />
</div>
