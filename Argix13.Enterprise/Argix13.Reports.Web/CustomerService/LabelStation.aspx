<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LabelStation.aspx.cs" Inherits="LabelStation" %>
        ...
        <td colspan="3">
            <table width="100%" border="0px" cellpadding="0px" cellspacing="0px">
                <tr style="height:16px">
                    <td style="font-size:1.0em; vertical-align:middle; padding-left:6px; background-image:url(../App_Themes/Reports/Images/gridtitle.gif); background-repeat:repeat-x;">&nbsp;Clients</td>
    ...
    <tr>
        <td colspan="2">
            ...
            <ContentTemplate>
                ...
                &nbsp;<asp:ImageButton ID="btnFind" runat="server" ImageUrl="~/Content/Images/search.gif" BorderStyle="Outset" BorderWidth="2px" Height="16px" ImageAlign="Middle" ToolTip="Search for Argix cartons" OnClick="OnFindCartons" />
            </ContentTemplate>
            </asp:UpdatePanel>
        </td>
        <td>&nbsp;</td>
                    ...
                    <td valign="top">
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnlCartons" runat="server" Width="100%" Height="192px" BorderStyle="Inset" BorderWidth="1px" ScrollBars="Horizontal">
                                ...
                                <asp:ObjectDataSource ID="odsCartons" runat="server" TypeName="Argix.EnterpriseRGateway" SelectMethod="GetCartons" EnableCaching="false" >
                                    <SelectParameters>
