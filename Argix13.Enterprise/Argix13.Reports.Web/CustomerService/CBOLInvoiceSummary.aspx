<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CBOLInvoiceSummary.aspx.cs" Inherits="CBOLInvoiceSummary" %>
...
<div style="margin:50px 0px 0px 39px">
    <label for="txtFrom">Invoices&nbsp;</label>
