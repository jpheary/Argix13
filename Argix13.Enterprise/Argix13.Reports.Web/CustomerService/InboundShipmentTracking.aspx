<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="InboundShipmentTracking.aspx.cs" Inherits="InboundShipmentTracking" %>
...
<div style="margin:0% 2% 0% 0%; text-align:right">
    <asp:CheckBox ID="chkAllDivisons" runat="server" width="288px" Text="Pickups for all divisions" TextAlign="Left" Checked="true" AutoPostBack="True" OnCheckedChanged="OnAllDivisionsChecked" /></td><td style="text-align:right"><asp:CheckBox ID="chkAllVendors" runat="server" width="288px" Text="Pickups for all vendors" TextAlign="Left" Checked="true" AutoPostBack="True" OnCheckedChanged="OnAllVendorsChecked" />
</div>
