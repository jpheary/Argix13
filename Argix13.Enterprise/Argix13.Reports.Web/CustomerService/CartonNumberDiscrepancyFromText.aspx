<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CartonNumberDiscrepancyFromText.aspx.cs" Inherits="CartonNumberDiscrepancyWithText" %>
...
<div style="margin:10px 0px 0px 35px">
    Manifest&nbsp;
    <asp:TextBox ID="txtNumbers" runat="server" Width="384px" Height="60px" MaxLength="2048000" TextMode="MultiLine" AutoPostBack="True" OnTextChanged="OnNumbersChanged" />
</div>
