<%@ Page Language="C#" MasterPageFile="~/Site.Executive.master" AutoEventWireup="true" CodeFile="DeliveryWindowDetailByStore.aspx.cs" Inherits="DeliveryWindowDetailByStore" %>
...
<asp:Content ID="idControl1" ContentPlaceHolderID="FilterControl1" Runat="Server">
    ...
    <asp:ObjectDataSource ID="odsExceptions" runat="server" TypeName="Argix.EnterpriseRGateway" SelectMethod="GetDeliveryExceptions" EnableCaching="true" CacheExpirationPolicy="Sliding" CacheDuration="600" />
</asp:Content>
