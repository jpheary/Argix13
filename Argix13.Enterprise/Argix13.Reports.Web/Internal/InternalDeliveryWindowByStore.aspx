<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="InternalDeliveryWindowByStore.aspx.cs" Inherits="InternalDeliveryWindowByStore" %>
    ...
    <table width="100%" border="0px" cellpadding="0" cellspacing="3px">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:ObjectDataSource ID="odsDates" runat="server" TypeName="Argix.EnterpriseRGateway" SelectMethod="GetSortDates" EnableCaching="true" CacheExpirationPolicy="Sliding" CacheDuration="600" />
            </td>
            <td>&nbsp;</td>
        </tr>
