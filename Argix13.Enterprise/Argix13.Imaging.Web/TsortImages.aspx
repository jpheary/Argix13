<%@ page language="C#" masterpagefile="~/Imaging.master" autoeventwireup="true" enableeventvalidation="false" CodeFile="TsortImages.aspx.cs" inherits="_TsortImages" %>
<%@ MasterType VirtualPath="~/Imaging.master" %>

<asp:Content ID="cBody" runat="server" ContentPlaceHolderID="cpBody">
<div class="subtitle">Tsort Images</div>
        ...
        <table style="width:100%; text-align:left">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="cboOperand2" runat="server"  Width="75px" AutoPostBack="True" OnSelectedIndexChanged="OnOperandSelectedIndexChanged" ><asp:ListItem Text="AND" Value="AND" /><asp:ListItem Text="OR" Value="OR" /></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:DropDownList ID="cboProp3" runat="server" DataSourceID="odsMetaData" DataTextField="Property" DataValueField="Value" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="OnPropertySelectedIndexChanged" />
                    <asp:TextBox ID="txtSearch3" runat="server" MaxLength="30" AutoPostBack="True" OnTextChanged="OnSearchTextChanged" />
                    <asp:DropDownList ID="cboOperand3" runat="server" Width="75px" AutoPostBack="True" OnSelectedIndexChanged="OnOperandSelectedIndexChanged" ><asp:ListItem Text="AND" Value="AND" /><asp:ListItem Text="OR" Value="OR" /></asp:DropDownList></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:DropDownList ID="cboProp4" runat="server" DataSourceID="odsMetaData" DataTextField="Property" DataValueField="Value" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="OnPropertySelectedIndexChanged" />
                    <asp:TextBox ID="txtSearch4" runat="server" MaxLength="30" AutoPostBack="True" OnTextChanged="OnSearchTextChanged" />
                </td>
            </tr>
        </table>
...
<div class="services">
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="cboOperand2" EventName="SelectedIndexChanged" />
        <asp:AsyncPostBackTrigger ControlID="cboProp3" EventName="SelectedIndexChanged" />
        <asp:AsyncPostBackTrigger ControlID="txtSearch3" EventName="TextChanged" />
        <asp:AsyncPostBackTrigger ControlID="cboOperand3" EventName="SelectedIndexChanged" />
        <asp:AsyncPostBackTrigger ControlID="cboProp4" EventName="SelectedIndexChanged" />
        <asp:AsyncPostBackTrigger ControlID="txtSearch4" EventName="TextChanged" />
        <asp:AsyncPostBackTrigger ControlID="txtSearch1" EventName="TextChanged" />
    </Triggers>
    </asp:UpdatePanel>
